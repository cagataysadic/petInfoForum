...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="flex w-screen justify-center py-2 bg-green-300">
      <div className="flex w-1/4 justify-between">
        ...
        {!token &&
          ...
          {token && (
            <div className="relative flex items-center transition-colors duration-300 ease-in-out"
              ...
              {isProfileDropdownVisible && (
                <div className="bg-green-300 absolute left-1/2 transform -translate-x-1/2 lg:mt-32 mt-32 lg:text-lg text-sm whitespace-nowrap z-5 flex flex-col rounded-md justify-center items-center lg:pb-5 pb-1">
                  <button onClick={handleDeleteAccount} className="text-neutral-900 hover:text-green-800 lg:px-4 lg:pt-4 px-1 pt-1">Delete Account</button>
                  <button onClick={handleLogout} className="text-neutral-900 hover:text-green-800 lg:px-4 lg:pt-4 px-1 pt-2">Logout</button>
                </div>
              )}
            </div>
          )}
        ...
        <Modal
          ...
          className="absolute lg:top-20 lg:left-12 top-10 left-4 h-36 w-auto bg-green-300 lg:p-8 p-4 lg:shadow-lg shadow-sm z-10 lg:rounded-xl rounded-lg"
